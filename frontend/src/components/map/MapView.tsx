...
function BBoxLoader({ onLoad, refreshKey, onError }: LoaderProps) {
  const map = useMap();
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      onLoad([]);
      onError('Could not load territories from backend.');
    }
  }, [map, onLoad, onError]);
  ...
  return (
    <div className="ff-map-view">
      ...
      >
        ...
        <BBoxLoader onLoad={setTerritories} onError={setLoadError} refreshKey={refreshKey} />
      ...
      {loadError && (
        <div
          style={{
            ...
            fontWeight: 700,
            boxShadow: '0 3px 0 rgba(45,16,64,0.15)',
          }}
        >
          {loadError}
        </div>
